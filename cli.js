...
const helpers_1 = __webpack_require__(/*! ./src/helpers */ "./src/helpers.ts");
const defaultSourceFileName = 'input.csv';
const dialog = readline.createInterface({
    input: process.stdin,
    output: process.stdout,
});
const startDialog = (question) => {
    try {
        const sourceFileName = process.argv[2];
        if (sourceFileName?.length &&
            !helpers_1.csvFileExtensionRegex.test(sourceFileName)) {
            console.log('Incorrect input file name.');
            process.exit(1);
        }
        if (!sourceFileName?.length) {
            dialog.question(question, (answer) => {
                const isValidOutputCsvFileName = !answer.length || helpers_1.csvFileExtensionRegex.test(answer);
                answer = answer?.length ? answer : defaultSourceFileName;
                if (isValidOutputCsvFileName) {
                    dialog.write(`Source file name: ${answer}\n`);
                    (0, api_1.executeTransformation)(answer);
                }
                else {
                    startDialog('Source file name is incorrect, please try again: ');
                }
            });
        }
        else {
            (0, api_1.executeTransformation)(sourceFileName);
        }
    }
    catch (e) {
...
startDialog(`Please, type input file name (default is "${defaultSourceFileName}"): `);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.createChunks = exports.rotateTable = exports.executeTransformation = void 0;
const fs = __importStar(__webpack_require__(/*! fs */ "fs"));
const csv = __importStar(__webpack_require__(/*! fast-csv */ "./node_modules/fast-csv/build/src/index.js"));
const helpers_1 = __webpack_require__(/*! ./helpers */ "./src/helpers.ts");
const executeTransformation = (fileName) => {
    ...
    fs.createReadStream(fileName)
        ...
        if (id.length && json.length) {
            const result = (0, exports.rotateTable)(JSON.parse(json), JSON.parse(id));
...
exports.executeTransformation = executeTransformation;
const rotateTable = (data, id) => {
    const tableChunkLength = Math.sqrt(data.length);
    let isTableValid = false;
    if (data.length && Number.isInteger(tableChunkLength))
        isTableValid = true;
    if (!isTableValid) {
        // console.log(`invalid data: id=${id}, data=${JSON.stringify(data)}, returning []`);
        return [];
    }
    const chunks = (0, exports.createChunks)(data, tableChunkLength);
    ...
    const rotatedTableResult = [];
    if ((0, helpers_1.isOdd)(tableChunkLength)) {
        // odd table size
        chunks.forEach((chunk, rowIndex) => {
            ...
            chunk.forEach((elem, columnIndex) => {
                ...
                if (isUpperPartOfTheTable) {
                    if (columnIndex >= columnSquareStartIndex &&
...
const createChunks = (data, chunkSize) => {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.csvFileExtensionRegex = exports.isOdd = void 0;
const isOdd = (num) => {
    return num % 2 === 1;
};
exports.isOdd = isOdd;
exports.csvFileExtensionRegex = /.+(\.csv)$/;
